...
/*============================================================================*/
str_t E(E_t * ζ, int entry) {
    if (entry == α) goto E_α;
    if (entry == β) goto E_β;
    /*------------------------------------------------------------------------*/
    str_t         V8;
    V_t           V8_ζ;
    V8_α:         V8 = V(&V8_ζ, α);                         goto V8_λ;
    V8_β:         V8 = V(&V8_ζ, β);                         goto V8_λ;
    V8_λ:         if (is_empty(V8))                         goto V8_ω;
                  else                                      goto V8_γ;
    /*------------------------------------------------------------------------*/
    str_t         I9;
    I_t           I9_ζ;
    I9_α:         I9 = I(&I9_ζ, α);                         goto I9_λ;
    I9_β:         I9 = I(&I9_ζ, β);                         goto I9_λ;
    ...
    str_t         X12;
    X_t           X12_ζ;
    X12_α:        X12 = X(&X12_ζ, α);                       goto X12_λ;
    X12_β:        X12 = X(&X12_ζ, β);                       goto X12_λ;
...
/*============================================================================*/
str_t X(X_t * ζ, int entry) {
    if (entry == α) goto X_α;
    if (entry == β) goto X_β;
    /*------------------------------------------------------------------------*/
    str_t         E17;
    E_t           E17_ζ;
    E17_α:        E17 = E(&E17_ζ, α);                       goto E17_λ;
    E17_β:        E17 = E(&E17_ζ, β);                       goto E17_λ;
    ...
    str_t         X19;
    X_t           X19_ζ;
    X19_α:        X19 = X(&X19_ζ, α);                       goto X19_λ;
    X19_β:        X19 = X(&X19_ζ, β);                       goto X19_λ;
    ...
    str_t         E21;
    E_t           E21_ζ;
    E21_α:        E21 = E(&E21_ζ, α);                       goto E21_λ;
    E21_β:        E21 = E(&E21_ζ, β);                       goto E21_λ;
    ...
    str_t         X23;
    X_t           X23_ζ;
    X23_α:        X23 = X(&X23_ζ, α);                       goto X23_λ;
    X23_β:        X23 = X(&X23_ζ, β);                       goto X23_λ;
    ...
    str_t         E25;
    E_t           E25_ζ;
    E25_α:        E25 = E(&E25_ζ, α);                       goto E25_λ;
    E25_β:        E25 = E(&E25_ζ, β);                       goto E25_λ;
    ...
    str_t         X27;
    X_t           X27_ζ;
    X27_α:        X27 = X(&X27_ζ, α);                       goto X27_λ;
    X27_β:        X27 = X(&X27_ζ, β);                       goto X27_λ;
    ...
    str_t         E29;
    E_t           E29_ζ;
    E29_α:        E29 = E(&E29_ζ, α);                       goto E29_λ;
    E29_β:        E29 = E(&E29_ζ, β);                       goto E29_λ;
    ...
    str_t         X31;
    X_t           X31_ζ;
    X31_α:        X31 = X(&X31_ζ, α);                       goto X31_λ;
    X31_β:        X31 = X(&X31_ζ, β);                       goto X31_λ;
    ...
    str_t         X34;
    X_t           X34_ζ;
    X34_α:        X34 = X(&X34_ζ, α);                       goto X34_λ;
    X34_β:        X34 = X(&X34_ζ, β);                       goto X34_λ;
    ...
    str_t         X37;
    X_t           X37_ζ;
    X37_α:        X37 = X(&X37_ζ, α);                       goto X37_λ;
    X37_β:        X37 = X(&X37_ζ, β);                       goto X37_λ;
    ...
    str_t         E38;
    E_t           E38_ζ;
    E38_α:        E38 = E(&E38_ζ, α);                       goto E38_λ;
    E38_β:        E38 = E(&E38_ζ, β);                       goto E38_λ;
...
str_t C(C_t * ζ, int entry) {
    ...
    str_t         X42;
    X_t           X42_ζ;
    X42_α:        X42 = X(&X42_ζ, α);                       goto X42_λ;
    X42_β:        X42 = X(&X42_ζ, β);                       goto X42_λ;
...
__kernel void snobol(
    ...
    str_t         C46;
    C_t           C46_ζ;
    C46_α:        C46 = C(&C46_ζ, α);                       goto C46_λ;
    C46_β:        C46 = C(&C46_ζ, β);                       goto C46_λ;
