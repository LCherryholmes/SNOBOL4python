...
@pattern
def Date(): yield from (
    r'(Sun|Mon|Tue|Wed|Thu|Fri|Sat), [0-9] (Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec) [0-9]+ [0-9]{2}:[0-9]{2}:[0-9]{2} \+[0-9]+'
...
|   r'[0-9] (Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec) [0-9]+ [0-9]{2}:[0-9]{2}:[0-9]{2} -[0-9]+'
...
|   r'(Sun|Mon|Tue|Wed|Thu|Fri|Sat), [0-9] (Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec) [0-9]+ [0-9]{2}:[0-9]{2}:[0-9]{2} -[0-9]{4} \([A-Z]+\)'
...
|   r'(Sun|Mon|Tue|Wed|Thu|Fri|Sat), [0-9]+ (Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec) [0-9]+ [0-9]{2}:[0-9]{2}:[0-9]{2} [A-Z]+'
...
def X_OriginalArrivalTime(): yield from (
    r'[0-9]+ (Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec) [0-9]+ [0-9]{2}:[0-9]{2}:[0-9]{2}\.[0-9]+ \([A-Z]+\) [A-Z]+=\[[0-9][A-Z][0-9][A-Z]+[0-9]+:[0-9]+[A-Z][0-9]+[A-Z]+\]'
   #1:04 Dec 2006 13:51:56.0083 (UTC) FILETIME=[5C6CD030:01C717AB]
|   r'[0-9]+ (Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec) [0-9]+ [0-9]{2}:[0-9]{2}:[0-9]{2}\.[0-9]+ \([A-Z]+\) [A-Z]+=\[[0-9]+[A-Z][0-9]+:[0-9]+[A-Z][0-9]+[A-Z][0-9]\]'
...
|   r'[0-9]+ (Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec) [0-9]+ [0-9]{2}:[0-9]{2}:[0-9]{2}\.[0-9]+ \([A-Z]+\) [A-Z]+=\[[0-9]+[A-Z][0-9]+:[0-9]+[A-Z][0-9][A-Z][0-9][A-Z][0-9]\]'
   #1:27 Aug 2007 16:21:56.0899 (UTC) FILETIME=[6335D730:01C7E8C6]
|   r'[0-9]+ (Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec) [0-9]+ [0-9]{2}:[0-9]{2}:[0-9]{2}\.[0-9]+ \([A-Z]+\) [A-Z]+=\[[0-9]+[A-Z][0-9][A-Z][0-9]+:[0-9]+[A-Z][0-9]+[A-Z][0-9][A-Z]\]'
   #1:30 Dec 2007 23:56:16.0969 (UTC) FILETIME=[911D2B90:01C84B3F]
|   r'[0-9]+ (Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec) [0-9]+ [0-9]{2}:[0-9]{2}:[0-9]{2}\.[0-9]+ \([A-Z]+\) [A-Z]+=\[[A-Z]+[0-9][A-Z]+[0-9]:[0-9]+[A-Z][0-9]+[A-Z]+\]'
   #1:02 Jan 2008 01:00:50.0700 (UTC) FILETIME=[EADD1CC0:01C84CDA]
|   r'[0-9]+ (Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec) [0-9]+ [0-9]{2}:[0-9]{2}:[0-9]{2}\.[0-9]+ \([A-Z]+\) [A-Z]+=\[[A-Z][0-9]+[A-Z]+[0-9]:[0-9]+[A-Z][0-9]+[A-Z][0-9]+\]'
   #1:04 Jan 2008 01:25:28.0042 (UTC) FILETIME=[B0411CA0:01C84E70]
|   r'[0-9]+ (Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec) [0-9]+ [0-9]{2}:[0-9]{2}:[0-9]{2}\.[0-9]+ \([A-Z]+\) [A-Z]+=\[[A-Z][0-9]+:[0-9]+[A-Z][0-9]+\]'
...
|   r'"(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)[a-z] [A-Z][a-z]+" <(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)[a-z]\.[A-Z][a-z]+@[a-z]+\.[a-z]+>'
