...
#-------------------------------------------------------------------------------
pct_block =         ς('%{') + ARBNO(cBlockBody) + ς('%}')
pct_union =         ς('%union') + cBlock
pct_type =          ς('%type') + ς('<') + η() + identifier + ς('>') + η() + identifier
pct_token =         ς('%token') + (ς('<') + η() + identifier + ς('>') | ε()) + ζ('pct_token_names')
pct_token_names =   η() + ζ('pct_token_name') + FENCE(ζ('pct_token_names') | ε())
pct_token_name =    identifier | characterLiteral
pct_left =          ς('%left') + pct_token_names
pct_right =         ς('%right') + pct_token_names
pct_start =         ς('%start') + η() + identifier
pct_parse_param =   ς('%parse-param') + cBlock
pct_lex_param =     ς('%lex-param') + cBlock
pct_expect =        ς('%expect') + η() + integerLiteral
pct_define =        σ('%define') + η() + identifier + ς('.') + identifier + η() + identifier
#-------------------------------------------------------------------------------
