...
def _executor(self, uid, op, args): # §2.2.0.1(i): ... is represented ...
    match op: # §2.2.0.1(i): ... as an object and transformations are ...
        # §2.2.0.1(i): ... invoked using methods on these objects.
