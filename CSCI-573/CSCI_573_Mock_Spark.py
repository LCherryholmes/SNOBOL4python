...
# §2.1(ii): ... either (1) data in stable storage or (2) other RDDs.
...
# §4.2(i): ... and metadata about its partitioning scheme and data placement.
...
# §5.0.1(ii): The system runs over the Mesos cluster manager [17], ...
# §5.0.1(ii): ... allowing it to share resources with Hadoop, ...
